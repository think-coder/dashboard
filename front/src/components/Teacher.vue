          ...
          <table class="gridtable">
              ...
              <tr>
                  ...
                  <th class="content-box">
                      （<input v-model="score_teacher" oninput="if(value.length>3)value=value.slice(0,3)" max=100 min=1 class="style-static" />）<span>满分100</span>
                  </th>
              </tr>
              <tr>
                  <th class="content-box" colspan="2">对课程质量的总体评分</th>
                  <th class="content-box">
                      （<input v-model="score_course" oninput="if(value.length>3)value=value.slice(0,3)" max=100 min=1 class="style-static" />）<span>满分100</span>
                  </th>
              </tr>
              <tr>
